...
public class CommandMsg extends CommandHandler {
    ...
    public void execute() {
        ...
        sendMSG.add(actClient.username +": "+msg.params.get(0));
        ...
        if (c != null) {
            ...
            responseMSG.add("Message: " + msg.params.get(0) + " send successful to: " + c.username);
            sendResponse(this.createResponse(200, responseMSG));
        } else {
            responseMSG.add("Message: " + msg.params.get(0) + " can't be send to: " + clientS + ". Client not exist.");
